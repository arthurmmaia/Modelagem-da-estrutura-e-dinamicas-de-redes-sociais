...
Este trabalho é uma replicação do modelo proposto em [1].
//
This work is a replication of the model proposed in [1]

## HOW IT WORKS

(1) Começa com uma rede de N0 vertices;
(2) Escolhe em media mr>= 1 vertices aleatorios como contatos iniciais;
(3) Escolhe em media ms>= 0 vizinhos de cada contato inicial como contato secundário;
(4) Conecta o novo vertecia ao contato inicial e aos secundários;
(5) Repere os passos 2 a 4 até que a rede cresça para o tamanho desejado.
...
Botões
setup - organiza a simulação para o seu estado inicial.
go - começa a simulação.
crete .csv - cria um arquivo do tipo .csv com todos os links existentes na simulação naquele momento.

Deslizadores
InitialNodes - define o número inicial de agentes na simulação.
DesiredNetworkSize - define o tamanho desejado da rede, quando a rede atinge esse tamanho a simulação para.

Monitores
number of nodes - mostra o numero de vertices existentes na rede.
Alone Nodes - mostra o numero de vertices com 0 coneções com outros vértices.

Graficos
Degree Distribution - histograma que apresenta a quantidade de nós com determinado grau.
...
Triangle changes over time -
Time Evolution of Triangles -
Clusterig coefficient - mostra a mudança do coeficiente de agrupamento com o passar do tempo.
Avarege degrees - mostra o grau médio de toda a rede.
//
Buttons
...
Esse trabalho ainda não está finalizado e sofrerá alterações.
//
